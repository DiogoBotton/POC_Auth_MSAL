...
const Login = () => {
  ...
  const handleLogin = () => {
    instance
      .loginPopup(loginRequest) // Usar loginRedirect posteriormente
      .then((response) => {
  ...
  const getUserPhoto = async () => {
    ...
    if (!response.ok) throw new Error("Erro ao obter foto de perfil");
        ...
        {isAuthenticated ? (
          ...
          <>
            <h1 className="login-title">
              Faça login para continuar (Azure AD)
            </h1>
